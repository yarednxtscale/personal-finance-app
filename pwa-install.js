...
style.textContent = `.pwa-install{position:fixed;left:16px;right:16px;bottom:92px;z-index:9990;background:#111827;color:#fff;border-radius:16px;padding:14px 16px;display:none;align-items:center;gap:12px;box-shadow:0 18px 50px rgba(0,0,0,.22)}.pwa-install.show{display:flex}.pwa-install-text{flex:1}.pwa-install-title{font-weight:800;font-size:14px}.pwa-install-sub{font-size:11px;color:#cbd5e1;margin-top:2px}.pwa-install button{border:0;border-radius:10px;padding:9px 12px;font-weight:800}.pwa-install .install{background:#fff;color:#111827}.pwa-install .dismiss{background:transparent;color:#cbd5e1}@media(max-width:700px){.pwa-install{left:14px;right:14px;bottom:82px;padding:12px 14px;border-radius:14px;gap:8px}.pwa-install-title{font-size:13px}.pwa-install-sub{font-size:10px}.pwa-install button{padding:8px 10px}}`;
